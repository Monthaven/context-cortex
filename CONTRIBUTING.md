...
2. Create `vendor/axon/src/axon/core/ingestion/languages/<lang>.py` following the pattern in `python.py` or `typescript.py`
3. Register the language in `vendor/axon/src/axon/core/ingestion/languages/__init__.py`
